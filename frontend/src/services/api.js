...
// Compras
export const getOrdensCompra = () => api.get('/compras');
export const getOrdemCompra = (id) => api.get(`/compras/${id}`);
export const getFornecedoresCompra = () => api.get('/compras/fornecedores');
export const createOrdemCompra = (data) => api.post('/compras', data);
export const updateOrdemCompra = (id, data) => api.put(`/compras/${id}`, data);
export const updateStatusOrdemCompra = (id, status) => api.put(`/compras/${id}/status`, { status });
export const deleteOrdemCompra = (id) => api.delete(`/compras/${id}`);
